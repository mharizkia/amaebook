            ...
            <div class="max-w-8xl mx-auto px-2 sm:px-6 lg:px-8"> 
                <div class="flex">
                    <h1 class="text-2xl font-bold mb-6 text-black w-auto max-w-sm">{{ $buku->judul }}</h1>
                        ...
                        <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="inline-flex items-center px-4 py-2 bg-red-500 text-white font-semibold text-xs uppercase rounded-md hover:bg-red-700 " type="button">
                        Delete
                        </button>
